...
tokens = {
    "lostcatbox": "2VquFPBm3lvWUyPkdt9NPPhSAe6_7nQNMwJmWhGiASYyMCaiw"
}


class ngrok:
  def __init__(self, TOKEN= "2VquFPBm3lvWUyPkdt9NPPhSAe6_7nQNMwJmWhGiASYyMCaiw", USE_FREE_TOKEN=False,
